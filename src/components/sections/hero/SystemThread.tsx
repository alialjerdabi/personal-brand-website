    ...
    <>
      ...
      <div
        className={`z-20 border-b sm:sticky sm:top-0 motion-safe:transition-colors motion-safe:duration-300 ${
          docked
            ? "border-transparent sm:border-border sm:bg-background/90 sm:backdrop-blur-sm"
            : "border-transparent"
        }`}
      >
        <Container size="wide">
          <div className="entrance-5 flex items-baseline justify-between gap-6 py-4 font-mono text-[11px] uppercase tracking-[0.2em] text-foreground-faint">
            <p>
